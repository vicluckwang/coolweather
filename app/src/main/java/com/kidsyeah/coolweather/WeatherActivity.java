...
import com.kidsyeah.coolweather.gson.Forecast;
import com.kidsyeah.coolweather.gson.LifeStyle;
import com.kidsyeah.coolweather.gson.Weather;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String location) {
        final String weatherUrl = "https://free-api.heweather.com/s6/weather?location=" + location + "&key=3d2fb0da68464479bc558839ea95fef2";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String comfort = null, carWash = null, sport = null;
        for(LifeStyle lifeStyle : weather.lifeStyleList) {
            if("comf".equals(lifeStyle.typ)) {
                comfort = lifeStyle.txt;
            } else if("cw".equals(lifeStyle.typ)) {
                carWash = lifeStyle.txt;
            } else if("sport".equals(lifeStyle.typ)) {
                sport = lifeStyle.txt;
            }
        }
